//============================================================================
//  VENDORED into the Toobin' core from rmonic79's Arcade-Raiden_MiSTer
...
//      Upstream hardcoded AW=10, i.e. 512 samples per bank, which is enough
//      for Raiden's 320-pixel line but NOT for Toobin': our line is 640 ce_pix
//      wide (toobin_raster H_LAST=639), so wrp would wrap mid-line and the
//      write pointer would corrupt the buffer.
...
//  see toobin_analog_adjust.sv, where it had to be re-derived because our
//  pixel period is 4 clk_sys cycles against Raiden's 16.
//============================================================================
